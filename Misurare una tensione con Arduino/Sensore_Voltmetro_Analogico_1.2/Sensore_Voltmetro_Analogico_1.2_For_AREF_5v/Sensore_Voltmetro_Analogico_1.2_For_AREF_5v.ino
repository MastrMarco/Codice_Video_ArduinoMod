...
const float VoltRef = 4.856;  // V = 5.XXX | mV = 5XXX.00 Tensione di riferimento per i pin Analogici
float Con;
...
float ADJ_Error = 0.00;  //Valore in Volt da aggiungere per diminuire l'errore di lettura
